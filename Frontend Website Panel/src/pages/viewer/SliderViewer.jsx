      ...
      <div className="p-6 lg:p-8 max-w-7xl mx-auto space-y-6 animate-fade-in">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-extrabold text-slate-800 tracking-tight flex items-center gap-2.5">
              ...
              <span>Daftar Slider Banner Utama</span>
            </h1>
            <p className="text-xs text-slate-500 mt-1">
              Pantau banner promosi yang aktif di beranda
            </p>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs flex flex-col sm:flex-row gap-3 items-center justify-between">
          ...
          <select
            ...
            className="w-full sm:w-auto px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold text-slate-700 focus:outline-none focus:border-teal-500 cursor-pointer"
          >
        ...
        {loading ? (
          ...
          <div className="p-12 text-center bg-white rounded-3xl border border-slate-200 shadow-xs space-y-3">
            ...
            <p className="text-xs text-slate-400 max-w-sm mx-auto">
              Tidak ada slider yang sesuai dengan filter Anda.
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <div className="w-full h-48 relative bg-slate-900 overflow-hidden">
                  ...
                  <div className="absolute top-3 left-3">
                    <span className="px-2.5 py-1 rounded-lg bg-teal-600/90 text-white font-bold text-[10px] uppercase shadow-sm">
                      {item.jenis || "BANNER"}
                    </span>
                  </div>
