...
export default function NewsReport() {
  ...
  const handleExportCSV = () => {
    exportToCSV(reports, "laporan_pembaca_berita", [
      { key: "id", label: "ID Laporan" },
      { key: "title", label: "Judul Berita" },
      { key: "username", label: "Pengguna / Pembaca" },
      { key: "views", label: "Jumlah Tayangan (Views)" },
      { key: "created_at", label: "Waktu Akses" },
    ]);
  };
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-extrabold text-slate-800 tracking-tight flex items-center gap-2.5">
              ...
              <span>Laporan Pembaca Berita (News Reports)</span>
            </h1>
            <p className="text-xs text-slate-500 mt-1">
              Pantau statistik jumlah tayangan (*views*) dan log pembaca artikel berita
            </p>
          </div>
                ...
                {loading ? (
                  ...
                  reports.map((item, idx) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-6">
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-blue-50 text-blue-700 font-extrabold text-[11px]">
                          <Eye size={12} />
